ifelse(tolower(getwd())!="f:/education/coursera data science jhu/04 exploratory data analysis/assignment01/",
       setwd("f:/education/coursera data science jhu/04 exploratory data analysis/assignment01/"), getwd())
